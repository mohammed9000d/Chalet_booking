...
class EditInfoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('owner.editchalets.index',['chalets'=>$chalets]);
    }
    ...
    public function create()
    {
        ...
        // return view('owner.editchalets.create', ['cities'=>$cities], ['owners'=>$owners]);
    }
    ...
    public function store(Request $request)
    {
        ...
        //     $name = time() . '_' . $request->get('first_name') . '.' . $chaletImage->getClientOriginalExtension();
    ...
    public function edit($id)
    {
        ...
        $chalet = Chalet::where('owner_id', '=', Auth()->user()->id)->find($id);
        return view('owner.editchalets.edit', ['cities'=>$cities, 'owners'=>$owners, 'chalet'=>$chalet]);
    }

...
@section('action')
    <div class="col-sm-5 col">
        <a href="{{ route('sliders.create') }}" class="btn btn-primary float-right mt-2">Add</a>
    </div>
@endsection
                        ...
                        <table class="datatable table table-hover table-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $slider->chalet_id }}</td>
                                    <td>{{ $slider->created_at }}</td>
                                    <td>
                                        <a href = "#" onclick = "confirmDelete(this,'{{ $slider->id }}')" type="button" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>

                ...
                @endif
                    ...
                    @method('put')
                        ...
                        <div class="form-group">
                            ...
                            <input name="first_name" value="{{$owner->first_name}}" type="text" class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Last Name</label>
                            <input name="last_name" value="{{$owner->last_name}}" type="text" class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Email</label>
                            <input name="email" value="{{$owner->email}}" type="email" class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Mobile</label>
                            <input name="mobile" value="{{$owner->mobile }}" type="tel" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Birth Date</label>
                            <input name="birth_date" value="{{$owner->birth_date}}" type="date" class="form-control">
                        </div>

        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Comment & Rate</h4>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10"><grammarly-extension data-grammarly-shadow-root="true" class="cGcvT" style="position: absolute; top: 0px; left: 0px; pointer-events: none;"></grammarly-extension>
                                <textarea rows="5" cols="5" class="form-control" placeholder="Enter comment here" spellcheck="false" name="comment" value="{{ old('comment') }}"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
